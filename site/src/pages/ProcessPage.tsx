        ...
        <div className="container">
          ...
          >
            ...
            <motion.p className="p" variants={reveal}>
              Nossa atuação combina método técnico, inteligência aplicada com
              propósito e planejamento tecnológico de longo prazo para construir
          ...
          >
            {[
              {
                n: "01",
                t: "Estrutura antes da velocidade",
                d: "Primeiro consolidamos direção e arquitetura, depois aceleramos execução.",
              },
              {
                n: "02",
                t: "IA com foco em ROI",
                d: "Aplicamos IA onde há impacto mensurável e ganho claro para o negócio.",
              },
              {
                n: "03",
          ...
          >
            <h3 className="card__title">
              Curva de evolução tecnológica orientada por arquitetura
            </h3>
            <svg
              viewBox="0 0 420 190"
              className="inlineChart"
              role="img"
              aria-label="Gráfico com evolução de estrutura, integração e escala"
            >
              <rect
                x="0"
                y="0"
              ...
              />
              <polyline
                points="40,138 120,122 200,98 280,76 390,56"
                fill="none"
                stroke="#0E2A3A"
                strokeWidth="3"
              />
              <polyline
                points="40,144 120,134 200,116 280,94 390,72"
                fill="none"
                stroke="#2CC6B8"
                strokeWidth="3"
              />
              <text x="50" y="32" fontSize="11" fill="#1E1E1E">
                Maturidade tecnológica
              </text>
              <text x="265" y="56" fontSize="11" fill="#0E2A3A">
                Arquitetura
              </text>
              <text x="292" y="72" fontSize="11" fill="#2CC6B8">
                Escala
              </text>
            </svg>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            {[
              {
                t: "Estrutura antes da velocidade",
                d: "Construção sólida para evitar retrabalho e decisões frágeis.",
              },
              {
                t: "Tecnologia com propósito",
                d: "Aplicações orientadas por resultado real e contexto de negócio.",
              },
              {
                t: "Clareza estratégica",
                d: "Decisões transparentes, direcionamento técnico e priorização objetiva.",
              },
              {
                t: "Evolução contínua",
                d: "Aprimoramento constante de arquitetura, processos e entregas.",
              },
              {
                t: "Parceria de longo prazo",
                d: "Atuação próxima para sustentar crescimento com previsibilidade.",
              },
            ].map((item) => (
              <motion.div
